...
class BotHandler(object):
    ...
    def __init__(self, token, dialogue_manager):
        ...
        self.dialogue_manager.create_chitchat_bot()
...
def main():
    ...
    if not token:
        if not "TELEGRAM_TOKEN" in os.environ:
            ...
            #return #I commented out this line
        #token = os.environ["TELEGRAM_TOKEN"] #I commented out this line
    ...
    token = '725124098:AAF1jYYGOYJBofc_f_-Aj3FV7g29la5Owck'
